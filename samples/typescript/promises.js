...
function promisedOpen() {
    return __awaiter(this, void 0, void 0, function () {
        var connStr, conn, res, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.sql.promises.open(connStr)];
                case 1:
                    conn = _a.sent();
                    return [4 /*yield*/, conn.promises.query('select @@SPID as spid')];
                case 2:
                    res = _a.sent();
