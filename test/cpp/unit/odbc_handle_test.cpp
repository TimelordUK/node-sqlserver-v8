...
namespace mssql::test
{
  ...
  class MockOdbcConnectionHandle final : public IOdbcConnectionHandle
  {
  public:
    MOCK_METHOD(bool, alloc, (SQLHANDLE parent), (override));
    MOCK_METHOD(void, free, (), (override));
  ...
  class MockOdbcStatementHandle final : public IOdbcStatementHandle
  {
  public:
    MOCK_METHOD(bool, alloc, (SQLHANDLE parent), (override));
    MOCK_METHOD(void, free, (), (override));
  ...
  class MockOdbcConnection final : public IOdbcConnection
  {
  public:
    MOCK_METHOD(bool, Open, (const std::u16string &connectionString, int timeout), (override));
    ...
    MOCK_METHOD(bool, ExecuteQuery, (const std::u16string &sqlText, const std::vector<std::shared_ptr<QueryParameter>> &parameters, std::shared_ptr<QueryResult> &result), (override));
    MOCK_METHOD(const std::vector<std::shared_ptr<OdbcError>> &, GetErrors, (), (const, override));
    MOCK_METHOD(std::shared_ptr<IOdbcStatement>, CreateStatement, (StatementType type, const std::u16string &query, const std::u16string &tvpType), (override));
    MOCK_METHOD(std::shared_ptr<IOdbcStatement>, GetPreparedStatement, (const std::string &statementId), (override));
    MOCK_METHOD(std::shared_ptr<IOdbcStatement>, GetStatement, (const StatementHandle &handle), (override));
    MOCK_METHOD(std::shared_ptr<IOdbcStatement>, GetStatement, (int statementId), (const, override));
    MOCK_METHOD(bool, ReleasePreparedStatement, (const std::string &statementId), (override));
  };

  // Helper factory function to create mock handles
  static std::shared_ptr<IOdbcEnvironmentHandle> create_mock_environment_handle()
  {
    return std::make_shared<MockOdbcEnvironmentHandle>();
  }

  static std::shared_ptr<IOdbcConnectionHandle> create_mock_connection_handle()
  {
    return std::make_shared<MockOdbcConnectionHandle>();
  }

  static std::shared_ptr<IOdbcStatementHandle> create_mock_statement_handle()
  {
