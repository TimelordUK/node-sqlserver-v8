    ...
    class ParameterInfo {
        ...
        private:
            ...
            ValueType determineValueType(Napi::Value value) {
                ...
                if (value.IsBoolean()) return ValueType::Boolean;
                if (value.IsDate()) return ValueType::Date;
                if (value.IsBuffer()) return ValueType::Buffer;
                if (value.IsNull() || value.IsUndefined()) return ValueType::Null;
