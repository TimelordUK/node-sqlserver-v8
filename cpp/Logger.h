...
#define SQL_LOG_ERROR_STREAM(expr) do { \
...
#define SQL_LOG_WARNING_STREAM(expr) do { \
...
#define SQL_LOG_INFO_STREAM(expr) do { \
...
#define SQL_LOG_DEBUG_STREAM(expr) do { \
...
#define SQL_LOG_TRACE_STREAM(expr) do { \
