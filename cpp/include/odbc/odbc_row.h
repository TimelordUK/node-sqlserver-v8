...
namespace mssql
{
  ...
  public:
    ...
    // Debugging
    virtual void logDebug(LogLevel level = LogLevel::Debug, bool showValues = true, size_t maxValues = 5) const = 0;
    virtual std::string getDebugString(bool showValues = true, size_t maxValues = 5, bool compactFormat = false) const = 0;
  };
  ...
  public:
     ...
     */
    void logDebug(LogLevel level = LogLevel::Debug, bool showValues = true, size_t maxValues = 5) const override;
     ...
     */
    std::string getDebugString(bool showValues = true, size_t maxValues = 5, bool compactFormat = false) const override;
