...
namespace mssql
{
  ...
  public:
    ...
    MOCK_METHOD(void, logDebug, (LogLevel level, bool showValues, size_t maxValues), (const, override));
    MOCK_METHOD(std::string, getDebugString, (bool showValues, size_t maxValues, bool compactFormat), (const, override));
  };
