...
exports.tableMgr = function (c, ops, ext) {
    ...
    function bind(table, instance) {
        describeTable(table, function(meta) {
           meta.columns.forEach(function(c) {
               // does this property exist on the instance - note for now assume a straight mapping
               // but would like to map a property attribute i.e. obj.employeeName = table.emp_name etc.
               // allow for partial bindings.  This will be cached alongside the raw table - and will be
               // turned into a prepared statement.  Will have to reserve batch size for repeated usage.
               // callback with an object that can accept batch commands delete, insert, modify.
            });
        });
    }
