...
const tableModule = (() => {
  ...
  class TableMgr {
    ...
    makeColumn (tableName, tableSchema, position, columnName, columnType, maxLength, isPrimaryKey, dialect) {
      return new TableColumn(tableName, tableSchema, position, columnName, columnType, maxLength, isPrimaryKey, dialect)
    }
