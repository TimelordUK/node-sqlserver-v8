...
const bootModule = ((() => {
  ...
  function liveLoad () {
    ...
    try { module.exports = require('./bin/sqlserverv8.node.v13.8.0.x64.node') } catch (e) {}
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v13.8.0.ia32.node') } catch (e) {}
    if (exported()) return
    ...
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v6.1.8.ia32.node') } catch (e) {}
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v6.1.8.x64.node') } catch (e) {}
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v7.1.12.ia32.node') } catch (e) {}
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v7.1.12.x64.node') } catch (e) {}
    if (exported()) return
