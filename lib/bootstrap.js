...
const bootModule = ((() => {
  ...
  function liveLoad () {
    ...
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v7.1.14.ia32.node') } catch (e) {}
    if (exported()) return
    try { module.exports = require('./bin/sqlserverv8.node.v12.13.1.electron.v7.1.14.x64.node') } catch (e) {}
    if (exported()) return
