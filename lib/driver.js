...
var driverModule = (function () {
  ...
  function DriverMgr (sql) {
    ...
    function onReadAllQuery (notify, query, params, callback) {
      setImmediate(function () {
        reader.fetch(notify, query, params, {
    ...
    function readAllPrepared (notify, queryObj, params, cb) {
      workQueue.enqueue(driverCommandEnum.QUERY, onReadAllPrepared, [notify, queryObj, params, cb])
    }

    function readAllQuery (notify, queryObj, params, cb) {
      workQueue.enqueue(driverCommandEnum.QUERY, onReadAllQuery, [notify, queryObj, params, cb])
    }

    function realAllProc (notify, queryObj, params, cb) {
      workQueue.enqueue(driverCommandEnum.QUERY, onReadAllProcedure, [notify, queryObj, params, cb])
    }
