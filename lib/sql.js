...
function query(connectDetails, query, paramsOrCallback, callback) {
    ...
    return queryRaw(connectObj, query, chunky.params, function (err, results, more) {
        setImmediate(function () {
            if (chunky.callback) {
...
function queryRaw(connectDetails, query, paramsOrCallback, callback) {
