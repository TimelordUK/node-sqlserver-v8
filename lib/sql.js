...
function procedure_internal(ext, procedure, params, callback) {
    ...
    return ext.callProcedure(procedure, params, onProc);
}
...
function readall(q, notify, ext, query, params, callable, callback) {
    ...
    id = invoke(ext, query, params, function (err, results, params) {
...
function open(connectionString, callback) {
    ...
    function Connection() {
        ...
        this.queryRaw = function (query, paramsOrCallback, callback) {
            ...
            var op = {fn: readall, args: [q, notify, ext, query, chunky.params, false, chunky.callback]};
            q.push(op);

            if (q.length == 1) {

                readall(q, notify, ext, query, chunky.params, false, chunky.callback);
            }
        ...
        this.procedureMgr = function procedureMgr() {
            ...
            function callStoredProcedure(signature, paramsOrCallback, callback) {
                ...
                var notify = new StreamEvents();
                var op = {fn: readall, args: [q, notify, ext, signature, chunky.params, true, onProcRaw]};
                q.push(op);
                if (q.length == 1) {
                    readall(q, notify, ext, signature, chunky.params, true, onProcRaw);
                }
...
function queryRaw(connectionString, query, paramsOrCallback, callback) {
    ...
    function onOpen(err, connection) {
        ...
        readall(q, notify, ext, query, chunky.params, false, function (err, results, more) {
