...
function open(connectionString, callback) {
    ...
    dm.validateParameters([{type: 'string', value: connectionString, name: 'connection string'},
    ...
    function Connection() {
        ...
        this.queryRaw = function (query, paramsOrCallback, callback) {
            ...
            dm.validateParameters([{type: 'string', value: query, name: 'query string'}], 'queryRaw');
