...
function readall_proc(q, notify, native, query, params, callback) {
    readall_internal(q, notify, native, query, params, procedure_internal, callback);
}

function readall_query(q, notify, native, query, params, callback) {
    readall_internal(q, notify, native, query, params, query_internal, callback);
}

function readall_prepared(q, notify, native, query, params, callback) {
    readall_internal(q, notify, native, query, params, prepared_internal, callback);
}

function readall_internal(q, notify, native, query, params, invoke, callback) {
    ...
    function cbFreeStatement(results, more) {
        if (callback) {
    ...
    function procUnbind(results, more) {
        function onUnbind(err, op) {
            outputParams = op;
            cbFreeStatement(results, more);
            nextOp(q);
        }
