...
function NotifyFactory() {
    ...
    this.getChunkyArgs = getChunkyArgs;
...
// will now be ready to fetch out of the statement.
    ...
    this.nextOp = nextOp;
    this.execQueueOp = execQueueOp;
    this.objectify = objectify;
    this.freeStatement = freeStatement;
    this.readall_query = readall_query;
    this.readall_proc = readall_proc;
    this.readall_prepared = readall_prepared;
