...
exports.procedureMgr = function (c, ops, ext) {
    ...
    function callStoredProcedure(signature, paramsOrCallback, callback) {
        ...
        var op = {fn: dm.readall, args: [q, notify, ext, signature, chunky.params, true, onProcRaw]};
        q.push(op);
        if (q.length == 1) {
            dm.readall(q, notify, ext, signature, chunky.params, true, onProcRaw);
        }
