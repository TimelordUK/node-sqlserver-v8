...
(function (MsNodeSqlWrapperModule) {
    ...
    class Connection {
        ...
        runQuery(sql, params, method, options) {
        ...
        query(sql, params, options) {
            return this.runQuery(sql, params, this.legacy_conn.query, options);
        }
        queryRaw(sql, params, options) {
            return this.runQuery(sql, params, this.legacy_conn.queryRaw, options);
        }
        close() {
            return new Promise((resolve, reject) => {
