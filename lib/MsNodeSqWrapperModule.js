        ...
        subscribe() {
            ...
            if (query) {
                if (this._onMeta != null) {
                    query.on(_1.QueryEvent.meta, (m) => this._onMeta(m));
                }
                if (this._onColumn != null) {
                    query.on(_1.QueryEvent.column, (c, d, m) => this._onColumn(c, d, m));
                }
                if (this._onRowCount != null) {
                    query.on(_1.QueryEvent.rowCount, (m) => this._onRowCount(m));
                }
                if (this._onRow != null) {
                    query.on(_1.QueryEvent.row, (m) => this._onRow(m));
                }
                if (this._onDone != null) {
                    query.on(_1.QueryEvent.done, m => this._onDone(m));
                }
                if (this._onError != null) {
                    query.on(_1.QueryEvent.error, m => this._onError(m));
                }
                if (this._onClosed != null) {
                    query.on(_1.QueryEvent.closed, m => this._onClosed(m));
                }
                if (this._onSubmitted != null) {
                    query.on(_1.QueryEvent.submitted, m => this._onSubmitted(m));
                }
            }
        }
        subscribing() {
