...
function ConnectionWrapper (qu, defcb, nat, name) {
    ...
    function queryRaw (queryOrObj, paramsOrCallback, callback) {
        ...
        queryRawNotify(notify, queryOrObj, paramsOrCallback, callback);
        return notify;
    }

    function queryRawNotify (notify, queryOrObj, paramsOrCallback, callback) {
    ...
    function queryNotify (notify, queryOrObj, chunky) {
        ...
        return queryRawNotify(notify, queryOrObj, chunky.params, onQueryRaw);
    }
