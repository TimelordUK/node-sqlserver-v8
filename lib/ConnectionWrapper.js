...
function ConnectionWrapper (driver, defCb, name)
{
    ...
    function queryRawNotify (notify, queryOrObj, chunky) {
        ...
        var op = makeOp(driverMgr.readall_query,[notify, queryObj, chunky.params, chunky.callback]);
    ...
    function PreparedStatement(d, s, c, n, m) {
        ...
        function preparedQuery(paramsOrCallback, callback) {
            ...
            var queryObj = {};
            var op = makeOp(driverMgr.readall_prepared,[notify, queryObj, chunky.params, onPreparedQuery]);
            driverMgr.execQueueOp(op);
        }
