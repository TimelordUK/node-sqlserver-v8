...
var me = new require('./meta')
var sqlMeta = new me.Meta()
...
function ConnectionWrapper (driver, defCb, name) {
  ...
  t = new tm.TableMgr(publicApi, sqlMeta)
  p = new pm.ProcedureMgr(publicApi, nf, driverMgr, sqlMeta)
