...
var connectionModule = (function () {
  ...
  function ConnectionWrapper (driver, defCb, name) {
    ...
    function getUserType(name, callback) {
      sqlMeta.getUserType(this, name, callback)
    }
    ...
    p = new procedureModule.ProcedureMgr(publicApi, nf, driverMgr, sqlMeta)
